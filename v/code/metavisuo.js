...
export class metavisuo extends outlook.page {
    ...
    async get_metadb(dbname) {
        ...
        const structure = await server.exec("database", [dbname], "export_structure", []);
        //
...
export class database extends schema.database {
    ...
    *collect_labels() {
    ...
    get_away_entity(Foreign) {
        ...
        const dbname = Foreign.ref.dbname;
        //
...
class relation {
    ...
    get_marker_name() {
        ...
        const optional = this.is_optional();
        //
    ...
    is_id() {
        ...
        const column = this.src.columns[cname];
        //
